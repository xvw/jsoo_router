...
(* OASIS_START *)
(* DO NOT EDIT (digest: b4d294ab09a796ee4e21b214fb898468) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-docflags '-colorize-code -charset utf-8 -hide Pervasives'"
                   ];
                 run_path = "."
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "http://github.com/xvw/jsoo_router";
          bugreports = None;
          synopsis = "An extension point for routing using hash";
          description =
            Some
              [OASISText.Para "A super simple tool to write single page app"];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("js_of_ocaml",
                               Some (OASISVersion.VGreaterEqual "2.8.1"));
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "jsoo_router";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Ppx_router"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "jsoo_router";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_router.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/jsoo_router";
                      doc_title =
                        "Documentation and API reference for Router";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/xvw/jsoo_router.git";
                      src_repo_browser =
                        Some "https://github.com/xvw/jsoo_router";
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "-2\170]\132\153\224k\154\141\208w\003lJ\242";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
